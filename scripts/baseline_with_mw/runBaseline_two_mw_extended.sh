...
time=15 #TODO
output_dir="baseline_two_mw_extended_test_$(date +"%Y-%m-%d-%H:%M")" #TODO
experiment_dir="/home/siegli/Code/asl-17/experiment_outputs"
local_result_dir="${experiment_dir}/${output_dir}"
all_machines=("client1" "client2" "mw1" "mw2" "server1")
...
###TODOS
#vc=(24 32 48 64)
vc=(1 8 16 20 24 28 32 40 48 56 64)
vc=(28 32 40 48 56 64)
runs=(1 2)
nof_workers=(32 64)
...
if check_if_machines_down ${all_machines[@]}; then
    ./startVms.sh aslvm1 aslvm2 aslvm4 aslvm5 aslvm6
	if [ "$?" == "1" ]; then
...
create_output_dir $output_dir "client1" "client2" "mw1" "mw2" "server1"

from=("mw1" "mw2" "client1" "client2")
to=("mw1" "mw2" "server1")
...
get_experiment_logs $local_result_dir "./${output_dir}/*" client1 client2 mw1 mw2 server1
