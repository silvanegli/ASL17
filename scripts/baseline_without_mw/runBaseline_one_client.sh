...
#----------------------------------------------------------
output_dir="baseline_one_client_$(date +"%Y-%m-%d-%H:%M")"
all_machines=("client1" "server1" "server2")
from=("client1")
to=("server1" "server2")
...
#vc=(1 4 12 20 28 32 40 56 64)
runs=(1 2 3)
vc=(1 4 8 12 16 20 24 28 32 40 48)
...
echo "done with baseline for one client"
...
./stopVms.sh aslvm1 aslvm6 aslvm7
