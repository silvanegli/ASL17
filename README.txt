...
1) Source Code
--------------
Can all be found under https://gitlab.ethz.ch/siegli/asl-fall17-project/tree/master/src/

a) /src/ch/ethz/asltest/siegli/protocol contains classes related to the memcached protocol
inclusive parsing requests and responses

b) /src/ch/ethz/asltest/siegli/workers contains all threading related stuff such as the worker
...
https://gitlab.ethz.ch/siegli/asl-fall17-project/tree/master/experiment_outputs/useful
...
https://gitlab.ethz.ch/siegli/asl-fall17-project/tree/master/scripts/python_postprocessing
...
https://gitlab.ethz.ch/siegli/asl-fall17-project/tree/master/figures
